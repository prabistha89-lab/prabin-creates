...
export const services: Service[] = [
  ...
  },
  {
    ...
    summary: "AI-assisted digital campaigns that unite strategic content, strong creative and conversion-focused delivery.",
    description: "Plan and create responsive, AI-assisted marketing campaigns that communicate clearly across social media, websites, email and paid placements.",
    problems: ["Inconsistent digital campaigns", "Slow content production", "Unclear offers and weak audience targeting"],
    deliverables: ["AI-assisted campaign concepts", "Social media content systems", "Website and landing-page visuals", "Email graphics", "Display advertisements", "YouTube thumbnails"],
    idealClients: ["E-commerce", "Education", "Marketing teams", "Local and national campaigns"],
    benefits: ["Faster campaign development", "Clear conversion focus", "Consistent cross-channel delivery", "Efficient content variations"],
    process: [{ title: "Goal", text: "Identify the campaign objective, audience and placements." }, { title: "Direction", text: "Combine strategic insight with a distinctive creative hook." }, { title: "Create", text: "Use AI-assisted workflows to build content, sizes and variants efficiently." }, { title: "Optimise", text: "Review clarity, consistency and conversion focus at real display sizes." }],

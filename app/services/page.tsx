...
export const metadata: Metadata = { title: "AI-Powered Graphic Design and Print Services", description: "AI-powered branding, print, social media, advertising, pre-press and professional printing services in Nepal.", alternates: { canonical: "/services" } };

export default function ServicesPage() {
  return <>
    <PageHero eyebrow="Services" title="AI-powered graphic design, backed by print expertise." text="From a focused social creative to a complete professional print run, every service combines efficient AI-assisted workflows with human creative direction and careful production." />

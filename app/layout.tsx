  ...
  return (
    <html lang="en">
      <body className={`${heading.variable} ${body.variable}`}>
        ...
        <Footer />
        <a className="floating-contact" href={siteConfig.whatsappHref} target="_blank" rel="noreferrer" aria-label="Message Prabin on WhatsApp"><Icon name="message-circle" size={17} />WhatsApp</a>
        <ScrollTop />

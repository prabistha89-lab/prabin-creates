    ...
    <>
      <section className="hero grid-paper">
        <div className="container hero-grid">
          <Reveal className="hero-copy"><p className="eyebrow"><span className="status-dot" />AI-Powered Graphic Design and Print</p><h1>Smarter design. <em>Professional print.</em></h1><p className="hero-lead">I combine AI-assisted creative workflows with professional design judgement, pre-press expertise and dependable printing to help brands communicate with clarity and confidence.</p><div className="button-row"><Link href="/services" className="button">Explore Services<Icon name="arrow-right" size={18} /></Link><Link href="/contact?service=consultation" className="button button-outline">Book a Consultation</Link></div><div className="hero-proof"><span><b>AI + Human</b> creative direction</span><span><b>Design + Print</b> production ready</span><span><b>Bharatpur</b> Chitwan, Nepal</span></div></Reveal>
      ...
      <section className="experience-strip" aria-label="Areas of expertise"><div className="marquee-line">{["Branding", "Print Design", "Social Media", "Advertising", "Pre-press", "Marketing Graphics"].map((item) => <span key={item}><i />{item}</span>)}</div></section>

  ...
  return (
    <footer className="site-footer">
      <div className="container footer-statement">
        ...
        <Link href="/brand-audit-form" className="footer-project-link">Free brand audit<Icon name="arrow-right" size={22} /></Link>
      </div>
      <div className="container footer-grid">
        <div className="footer-intro">
          <Link href="/" className="footer-logo-wrap" aria-label="Designer Prabin home">
            <Image src="/Logo-01.svg" alt="Designer Prabin" width={210} height={90} unoptimized />
          </Link>
          <p>Graphic design, professional printing and AI digital marketing for businesses that value clarity, craft and consistent presentation.</p>
        ...
        <div><h2>Services</h2>{services.slice(0, 5).map((service) => <Link key={service.slug} href={`/services/${service.slug}`}>{service.shortTitle}</Link>)}</div>
